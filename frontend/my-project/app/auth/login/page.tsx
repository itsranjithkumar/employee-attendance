    ...
    <main className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#f5f6fa] via-[#d1d5db] to-[#a3a3a3] relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md p-10 rounded-3xl shadow-2xl bg-white/60 backdrop-blur-xl border border-gray-200">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 drop-shadow mb-2 luxury-font text-center">Sign in to your account</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
          ...
          <button
            type="submit"
            className="w-full apple-btn mt-2"
          >
            Sign In
          </button>
        </form>
